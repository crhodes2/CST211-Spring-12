...
class DoubleLinkedList
{
	...
	public:
		...
		void PrintForwards(void) const;
		void PrintBackwards(void) const;
};
...
************************************************************************/
template <class T>
DoubleLinkedList<T>::DoubleLinkedList(void) : m_head(0), m_tail(0)
{
...
************************************************************************/
template <class T>
Node<T>* DoubleLinkedList<T>::getHead(void) const
{
	return m_head;
}
...
************************************************************************/
template <class T>
Node<T>* DoubleLinkedList<T>::getTail(void) const
{
	return m_tail;
}
...
************************************************************************/
template <class T>
bool DoubleLinkedList<T>::isEmpty(void) const
{
	return (!m_head);
}
...
************************************************************************/
template <class T>
T const& DoubleLinkedList<T>::First(void) const
{
	T* data;
	if(!isEmpty())
	{
...
************************************************************************/
template <class T>
T const& DoubleLinkedList<T>::Last(void) const
{
	T* data;
	if(!isEmpty())
	{
...
************************************************************************/
template <class T>
void DoubleLinkedList<T>::Purge(void)
{
	// traverse the list, and delete data/nodes as we go
	Node<T>* trailing_ptr = 0;
	Node<T>* traveling_ptr = m_head;
...
************************************************************************/
template <class T>
void DoubleLinkedList<T>::PrintForwards(void) const
{
	Node<T>* traveling_ptr = m_head;
	while(traveling_ptr)
	{
...
************************************************************************/
template <class T>
void DoubleLinkedList<T>::PrintBackwards(void) const
{
